    ...
    <MessageCard
      ...
      title={
        <>
          ...
          <span className="text-2xs font-semibold uppercase tracking-wider text-foreground/80 shrink-0 font-mono">
      ...
      headerRight={
        <div className="flex items-center gap-1.5 shrink-0">
          {pair.result == null && (
            <Badge color="warning" pulse>running</Badge>
          )}
          {isError && <Badge color="danger">error</Badge>}
          <button
            onClick={() => setArgsExpanded(!argsExpanded)}
            className="text-2xs text-foreground/45 hover:text-foreground font-mono"
        ...
        <div>
          <button
            ...
            className={clsx(
              ...
              summary.kind !== "empty" && "cursor-pointer hover:text-foreground",
            )}
          >
            <span
              className={clsx(
                "text-2xs uppercase tracking-wider font-semibold shrink-0",
                isError ? "text-danger" : "text-foreground/55",
              )}
            >
            ...
            {summary.kind === "empty" ? (
              ...
              <>
                  ...
                  return hasAnsi ? (
                    ...
                    <span
                      className={clsx(
                        ...
                        summary.kind === "json" ? "text-foreground/60" : "text-foreground/75",
                      )}
                    >
                      {preview}
                    </span>
                ...
                <span className="ml-auto text-2xs text-foreground/40 font-mono shrink-0 flex items-center gap-2">
